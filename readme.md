...
per subdirectory are as follows:  
  ...
  * `tcr`: Contains the following well level files generated by `multi_output_formatting.sh` 
  ...
  * `bcr`: Contains the following well level files generated by `multi_output_formatting.sh` 
  from [`tenx-vdj-pipeline`](https://github.com/aifimmunology/tenx-vdj-pipeline)   
