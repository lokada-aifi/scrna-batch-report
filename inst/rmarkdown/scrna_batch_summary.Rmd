...
#' category levels. Parent chunk should have options knit = "as-is"
#'
...
```{r hto_cat_counts, fig.width = fig_width_n_pools, fig.height = 7, results = "asis"}
...
```{r umap_labels,  esults = "asis", fig.height = 22, fig.width = 20, class.output = "superbigimage"}
point_size <- 0.2
