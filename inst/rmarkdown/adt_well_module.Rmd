...
<details style="color: lightgray;"> 
  <summary>Expand output</summary>   
```{r adt_load inputs, message=FALSE, echo=FALSE}
...
```{r adt_Create Seurat Objects, message=FALSE, echo=FALSE}
i = 1
seurat_list <- list()
...
#### Split Violin Plot
```{r adt_split violin plot, fig.width=12, fig.height=8, message=FALSE, echo=FALSE}
...
```{r adt_UMAP Clustering for ADTs, message=FALSE, echo=FALSE}
...
```{r adt_UMAP clustering for ADTs individually, fig.width=12, fig.height=height, message=FALSE, echo=FALSE}
