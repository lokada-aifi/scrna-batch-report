...
if(is.null(params$in_dir)) {
  batch_id <- "X070"
  in_dir <- system.file("batchreporter/inst/extdata/X070")
  in_key <- system.file("batchreporter/inst/extdata/example_sample_key_X070.csv")
  in_config <- system.file("batchreporter/inst/extdata/default_rna_config_v1.csv")
  in_batch_meta <- system.file("batchreporter/inst/extdata/batch-metadata.json")
