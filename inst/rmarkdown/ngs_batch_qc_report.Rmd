...
```{r hashing_child, child="/batchreporter/inst/rmarkdown/hto_module.Rmd", eval=has_hto}
...
```{r scrna_seq_child, child="/batchreporter/inst/rmarkdown/scrna_well_module.Rmd", eval=has_rna}
...
```{r hashed_rna_child, child="/batchreporter/inst/rmarkdown/scrna_hashed_sample_module.Rmd", eval=has_rna & has_hto}
...
```{r adt_child, child="/batchreporter/inst/rmarkdown/adt_well_module.Rmd", eval=has_adt}
...
```{r hashed_adt_child, child="/batchreporter/inst/rmarkdown/adt_hashed_sample_module.Rmd", eval=has_adt & has_hto}
...
```{r atac_child, child="/batchreporter/inst/rmarkdown/scatac_seq_module.Rmd", eval=has_atac}
...
```{r hashed_atac_child, child="/batchreporter/inst/rmarkdown/scatac_hashing_module.Rmd", eval=has_atac & has_hto}
