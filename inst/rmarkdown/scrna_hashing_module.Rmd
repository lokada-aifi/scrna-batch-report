...
<!-- # in_key <- "/Users/lauren.okada/Packages/scrna-batch-report/inst/extdata/example_sample_key.csv" -->
<!-- # ``` -->
...
h5_file_type <- ifelse(h5_file_dir == h5_file_dir_options[2],"merged" ,
...
for (i in seq_along(pools)){
  ...
  # Plot
  g_ridge <- ggplot(df, aes(x =log_count, y=factor(well_id, levels = sort(unique(well_id), decreasing = T)))) +
