...
if(is.null(params$in_dir)) {
  batch <- "X002"
  rna_in_dir <- system.file("batchreporter/inst/extdata/X002")
  in_key <- system.file("batchreporter/inst/extdata/example_sample_key_X002.csv")
...
```{r scrna_seq_child, child =  system.file("batchreporter/inst/rmarkdown/scrna_seq_module.Rmd")}

```
  
### Cell Hashing 

```{r scrna_hashing_child, child = system.file("batchreporter/inst/rmarkdown/scrna_hashing_module.Rmd")} 
