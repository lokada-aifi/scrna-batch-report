...
has_controls <- any(grepl("Control", df_key$Type))
...
```{r scrna_seq_child, child = system.file("rmarkdown/scrna_metadata_module.Rmd", package = "batchreporter")}
...
cols_sample <- immutils::varibow(n_colors = length(unique(umapDF[,sample_column_name])))
