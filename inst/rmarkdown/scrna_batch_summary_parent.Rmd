...
```{r celltype_piechart_bymito_group, fig.width = 8, fig.height = 3.5}
...
temp_fig_height <- ceiling(n_cell_type_levels/ncol_plot)*1.5 + 0.25

make_subchunk(g_pie_cells, subchunk_name = "mito_group_piechart_bycelltype_subchunk", quiet_knit = T, chunk_opt_list = list(fig.width = temp_fig_width, fig.height = temp_fig_height, class.output = "superbigimage"))
```  
...
all_control <- all_control %>% 
  ...
  mutate(control_batch = paste(batch_id, collapse = ";")) %>%
  ungroup()
